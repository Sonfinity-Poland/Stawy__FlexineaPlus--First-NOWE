// last-lonely-letter
var tekst = document.getElementById("body").innerHTML;
tekst = tekst.replace(/(\s)([\S])[\s]+/g, "$1$2&nbsp;"); //jednoznakowe
// tekst = tekst.replace(/(\s)([^<][\S]{1})[\s]+/g, "$1$2&nbsp;"); //dwuznakowe
//tekst = tekst.replace(/(\s)([^<][\S]{2})[\s]+/g,"$1$2&nbsp;"); //trzyznakowe
document.getElementById("body").innerHTML = tekst;
...
function wyswietlDane() {
  ...
  switch (dzienTygodnia) {
    case 0:
      dzienTygodnia = "niedzieli";
      break;
    case 1:
      dzienTygodnia = "poniedziałku";
      break;
    case 2:
      dzienTygodnia = "wtorku";
      break;
    case 3:
      dzienTygodnia = "środy";
      break;
    case 4:
      dzienTygodnia = "czwartku";
      break;
    case 5:
      dzienTygodnia = "piątku";
      break;
    case 6:
      dzienTygodnia = "soboty";
      break;
  }

...
let commentsJSON = [
        ...
        "answers": [
            {
                nick: "Dawid",
                date: "3 godziny temu",
                content: "<b>@Katarzyna</b> odkąd się dowiedziałem o tej kuracji to zacząłem stosować na kręgosłup,pomogło mi więc sprezentowałem tacie, a ma 84 lata więc wiadomo ledwo łaził. A tak mu się poprawiło że założył mamy kapelusz i szlafrok i zaczął tańczyć hehe Więc polecam też tobie i twojej mamie",
                likes: 0,
                hasLiked: false,
            },
            {
  ...
  },
    {
        nick: "Robert",
        date: "wczoraj",
        content: "Mój brat polecił mi te naturalne kapsułki. Dostałem paczkę w przeciągu 3 dni. Jak na razie rezultaty są oszałamiające – ból pleców minął, a ja z każdym dniem czuję się lepiej! Nie mogę się już doczekać końca!",
        likes: 0,
        hasLiked: false,
    },
    {
...
function composeCommentNode(commentObj) {
    ...
    let whenStr = document.createElement("p");
...
function renderMockCommetns() {
    ...
    mockComments.forEach(element => {
        ...
        let tempStr = `
            <div class="comment cmt-section" id="${idx}">
                <div class="first-cmt cmt-section__border">
                    <div class="cmt-img">
                        <img src="assets/img/${element.nick}.jpg" alt="${element.nick}" >
                    </div>
                ...
                answerTwmplate = `
                        <div class="cmt-answers" id="${idx}">
                            <div class="comment answer cmt-section__border">
                                <div class="cmt-img">
                                    <img src="assets/img/${answerMock.nick}.jpg" alt="${answerMock.nick}">
                                </div>
                                <div class="cmtRight px-3">
                                    <div class="cmt-title">
